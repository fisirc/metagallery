...
import styles from './EditorMobileMenu.module.css';

interface EditorMobileMenuProps {
  MainButtons: React.ReactNode;
}

export const EditorMobileMenu = ({ MainButtons }: EditorMobileMenuProps) => {
          ...
          <div className={styles.menuPanel}>
            <div className={styles.menuContent}>
              <div className={styles.menuItem} onClick={closeMenu}>
                <span className={styles.menuLabel}>Acciones</span>
                {MainButtons}
              </div>
